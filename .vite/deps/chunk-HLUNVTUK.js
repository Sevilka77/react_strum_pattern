...
var useUtilityClasses = (ownerState, componentName) => {
  ...
  return composeClasses2(slots, getContainerUtilityClass2, classes);
};
  ...
  const Grid2 = React36.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React36.Children.map(children, (child) => {
        var _a;
        if (React36.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HLUNVTUK.js.map
